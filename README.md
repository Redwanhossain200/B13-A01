...
├── Sections/           # Screenshots of individual design sections
├── UI/                 # Full UI design assets (Figma, PDF, PNG)
...
- **Figma File:** Located in the root and `/UI` directory.
- **Full Preview:** `UI/Home.png` and `UI/KnowledgeVault.pdf`.
...
![Knowledge Vault Preview](./UI/Home.png)